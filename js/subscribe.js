let isChangeSubscribe = () => {
  ...
  value.innerHTML=`<h3 style="margin-left:5%">채용</h3>`
  value.innerHTML+=`<br>`
  value.innerHTML+=`<div class="card" style="width: 300px;height:200px;margin-right: 5%;margin-left:5%;position: relative;display: inline-block;" id="subscribeCard">
  <div class="card-body">
    <h5 class="card-title">원티드</h5>
    <p class="card-text">나다운 일의 시작</p>
    <button id="wanted_active" class="btn btn-secondary btn-block mb-4" onclick="isChangeActive('wanted_active')">
        비활성화
    </button>
  </div>
</div>`;

  value.innerHTML+=`<div class="card" style="width: 300px;height:200px;margin-left: 5%;display: inline-block;" id="subscribeCard">
  <div class="card-body">
    <h5 class="card-title">사람인</h5>
    <p class="card-text">취업/채용/커리어 매칭 플랫폼</p>
    <button id="saramin_active" class="btn btn-secondary btn-block mb-4" onclick="isChangeActive('saramin_active')">비활성화</button>
  </div>
  </div>`;

value.innerHTML+=`<br><br><br>`

  value.innerHTML+=`<h3 style="margin-left:5%">뉴스</h3>`
  value.innerHTML+=`<br>`
  value.innerHTML += `<div class="card" style="width: 300px;height:200px;margin-right: 5%;margin-left:5%;position: relative;display: inline-block;" id="subscribeCard">
  <div class="card-body">
    <h5 class="card-title">요즘 IT</h5>
    <p class="card-text">요즘 사람들의 IT 매거진, 요즘IT</p>
    <button id="yozm_active" class="btn btn-secondary btn-block mb-4" onclick="isChangeActive('yozm_active')">비활성화</button>
  </div>
</div>`;
...
<div class="card-body">
  ...
  <button id="coding_world_active" class="btn btn-secondary btn-block mb-4" onclick="isChangeActive('coding_world_active')">비활성화</button>
</div>
</div>`;

value.innerHTML+=`<br><br><br>`

  value.innerHTML+=`<h3 style="margin-left:5%">유튜브</h3>`
  value.innerHTML+=`<br>`
  value.innerHTML+= `<div class="card" style="width: 300px;height:200px;margin-right: 5%;margin-left:5%;position: relative;display: inline-block;" id="subscribeCard">
  <div class="card-body">
    <h5 class="card-title">드림코딩엘리</h5>
    <p class="card-text">엘리와 함께하는 드림코딩</p>
    <button id="dream_coding_active" class="btn btn-secondary btn-block mb-4" onclick="isChangeActive('dream_coding_active')">비활성화</button>
  </div>
</div>`;
...
value.innerHTML += `<div class="card" style="width: 300px;height:200px;margin-left: 5%;display: inline-block;" id="subscribeCard">
  <div class="card-body">
    ...
    <button id="nomad_coders_active" class="btn btn-secondary btn-block mb-4" onclick="isChangeActive('nomad_coders_active')" type="button">비활성화</button>
  </div>
</div>`;
